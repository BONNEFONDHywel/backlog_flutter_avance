                            ...
                            child: Card(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(18),
                                  ...
                                  !isUserRegistered(listConcours?[index]['participants'], user)?


                                          TextButton(
                                              onPressed: ()  {
                                                print(listConcours?[index]['participants']);
                                                print(!isUserRegistered(listConcours?[index]['participants'], user));
                                                showDialog(
                                                    context: context,
                                                    builder: (context) {
                                                      return SizedBox(
                                              ...
                                              child: const Text('Participer')):Text('Déjà Inscrit'),
                                        ],
                                      )
                                    ],
                                  )),
